  ...
  return (
    ...
    >
      ...
      <div className="legal-section">
        ...
        <p>
          Google account information is used only to authenticate the current user and show their profile details in
          the interface. Google Drive access is used to locate and read video files chosen by that user. Google Sheets
          access is used to create or update spreadsheets that store evaluation results.
        </p>
      </div>
      ...
      <div className="legal-section">
        <h2>Sharing</h2>
        <p>
          VidEval does not sell Google user data. Data accessed through Google APIs is used only to provide the core
          app workflow of reviewing videos and exporting evaluation results for the authenticated user.
        </p>
      </div>
